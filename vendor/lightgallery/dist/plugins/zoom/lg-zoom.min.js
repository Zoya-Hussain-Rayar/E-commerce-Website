...
!function(t, e) {
    ...
    return function() {
        ...
        h.prototype.getImageSize = function(t, e, o) {
            return 90 === Math.abs(e) && (o = "x" === o ? "y" : "x"),
            t[{
                y: "offsetHeight",
                x: "offsetWidth"
            }[o]]
        ...
        h.prototype.zoomImage = function(t) {
            ...
            var g = this.getDragAllowedAxises(Math.abs(this.rotateValue), t)
              , c = g.allowY
              , h = g.allowX;
            this.positionChanged && (e = this.left / (this.scale - 1),
        ...
        h.prototype.beginZoom = function(t) {
            ...
            t > 1) ? (this.core.outer.addClass("lg-zoomed"),
        ...
        h.prototype.init = function() {
            ...
            if (this.settings.zoom) {
                ...
                this.core.outer.on("touchstart.lg", (function(o) {
                    ...
                    e = null,
                    o.preventDefault(),
                    t.setActualSize(t.core.index, o)) : e = setTimeout((function() {
                        e = null
                    }
                    ), 300))
                }
                ...
                this.core.LGel.on(o + ".zoom " + l + ".zoom " + n + ".zoom " + g + ".zoom " + c + ".zoom", (function() {
                    t.core.lgOpened && t.isImageSlide() && (t.setPageCords(),
                    t.setZoomEssentials(),
                    t.zoomImage(t.scale))
                }
                )),
        ...
        h.prototype.pinchZoom = function() {
            ...
            this.core.$inner.on("touchstart.lg", (function(o) {
                ...
                t.isImageSlide() && (2 !== o.targetTouches.length || t.core.outer.hasClass("lg-first-slide-loading") || !t.$LG(o.target).hasClass("lg-item") && !s.get().contains(o.target) || (i = t.scale || 1,
            ...
            this.core.$inner.on("touchend.lg", (function(i) {
                ...
                e = 0,
                t.scale <= 1 ? t.resetZoom() : (t.scale = t.getScale(t.scale),
                t.zoomImage(t.scale),
        ...
        h.prototype.getZoomSwipeCords = function(t, e, o, i, s) {
            var a = {};
            if (i) {
                if (a.y = this.top + (e.y - t.y) * this.modifierY,
                ...
                a.y = this.top;
            if (o) {
                if (a.x = this.left + (e.x - t.x) * this.modifierX,
        ...
        h.prototype.zoomSwipe = function() {
            ...
            this.core.$inner.on("touchstart.lg", (function(s) {
                if (o.isImageSlide() && (g = o.core.getSlideItem(o.core.index),
                (o.$LG(s.target).hasClass("lg-item") || g.get().contains(s.target)) && 1 === s.targetTouches.length && o.core.outer.hasClass("lg-zoomed"))) {
                    s.preventDefault(),
                    l = new Date,
            ...
            this.core.$inner.on("touchmove.lg", (function(l) {
                if (1 === l.targetTouches.length && "zoomSwipe" === o.core.touchAction && (o.$LG(l.target).hasClass("lg-item") || g.get().contains(l.target))) {
                    ...
                    (Math.abs(s.x - i.x) > 15 || Math.abs(s.y - i.y) > 15) && (a = !0,
                    o.setZoomSwipeStyles(e, c))
                }
            }
            )),
        ...
        h.prototype.zoomDrag = function() {
            ...
            this.core.outer.on("mousedown.lg.zoom", (function(e) {
                if (s.isImageSlide()) {
                    ...
                    if (s.$LG(e.target).hasClass("lg-item") || r.get().contains(e.target)) {
                        t = new Date,
                        i = s.core.getSlideItem(s.core.index).find(".lg-img-wrap").first();
                        var l = s.getDragAllowedAxises(Math.abs(s.rotateValue));
                        c = l.allowY,
                        g = l.allowX,
                        s.core.outer.hasClass("lg-zoomed") && s.$LG(e.target).hasClass("lg-object") && (g || c) && (e.preventDefault(),
            ...
            this.$LG(window).on("mousemove.lg.zoom.global" + this.core.lgId, (function(t) {
                if (n) {
                    l = !0,
                    r = s.getDragCords(t, Math.abs(s.rotateValue));
